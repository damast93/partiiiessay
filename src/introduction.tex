...
Sketches eliminate the need for a language when writing down theories. Instead, the ``geometry'' of the sketch will determine the categorical properties of its category of models. The core theorem that links the key ideas of this essay is the following:
